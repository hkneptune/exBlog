...
$required_version_s = "01050020050721";
...
$sql_query_string[] = "alter table %%%PREFIX%%%upload add fulltext(destination_folder), add max_width tinyint(4) default 1, add max_height tinyint(4) default 1, add watermark_type enum('string','image') default 'string', add watermark text, modify destination_folder text  type=MYISAM";
// 2005-08-16
