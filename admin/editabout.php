...
class About extends CommonLib
{
	...
	function About()
	{
		...
		// 装入功能对应语言文件
		include_once("../{$this->_config['global']['langURL']}/editabout.php");
		$this->_lang['about'] = $lang;
		...
		// 获取关于信息
		if (FALSE == $this->_getAboutInfo()) $this->_showError($this->_lang['about'][10]);
  ...
  <tr bgcolor=\"#99CC66\">
    <td bgcolor=\"#FFFFFF\">
      <table width=\"100%\" border=\"0\" cellpadding=\"1\" cellspacing=\"1\" class=\"main\">
        <tr><td colspan=\"2\" class=\"menu\"><div align=\"center\">{$this->_lang['about'][0]}</div></td></tr>
        <tr><td width=\"9%\" valign=\"top\" align=\"right\">{$this->_lang['about'][1]}</td><td width=\"80%\"> <input name=\"name\" type=\"text\" value=\"{$this->about_info['name']}\" class=\"input\"></td></tr>
        <tr><td valign=\"top\" align=\"right\">{$this->_lang['about'][2]}</td><td><input name=\"age\" type=\"text\" class=\"input\" id=\"age\" value=\"{$this->about_info['age']}\" size=\"5\"></td></tr>
        <tr><td valign=\"top\" align=\"right\">{$this->_lang['about'][3]}</td><td><input name=\"email\" type=\"text\" class=\"input\" value=\"{$this->about_info['email']}\" size=\"30\"></td></tr>
        <tr><td valign=\"top\" align=\"right\">{$this->_lang['about'][4]}</td><td><input name=\"qq\" type=\"text\" class=\"input\" id=\"qq\" value=\"{$this->about_info['qq']}\"></td></tr>
        <tr><td valign=\"top\" align=\"right\">{$this->_lang['about'][5]}</td><td><input name=\"icq\" type=\"text\" class=\"input\" id=\"icq\" value=\"{$this->about_info['icq']}\"></td></tr>
        <tr><td valign=\"top\" align=\"right\">{$this->_lang['about'][6]}</td><td><input name=\"msn\" type=\"text\" class=\"input\" id=\"msn\" value=\"{$this->about_info['msn']}\" size=\"30\"></td></tr>
        <tr><td valign=\"top\" nowrap>{$this->_lang['about'][7]}</td><td><textarea name=\"description\" cols=\"60\" rows=\"8\" wrap=\"VIRTUAL\" class=\"input\" id=\"description\">{$this->about_info['description']}</textarea></td></tr>
        <tr><td colspan=2>&nbsp;</td></tr>
        <tr><td colspan=\"2\"><div align=\"center\">
          <input type=\"hidden\" name=\"action\" value=\"gogogo\">
          <input type=\"submit\" value=\"{$this->_lang['about'][8]}\" class=\"botton\"> &nbsp;&nbsp;&nbsp;&nbsp; <input type=\"submit\" value=\"{$this->_lang['about'][9]}\" class=\"botton\">
        </div></td></tr>
      </table>
    </td>
  </tr>
	...
	function _checkForm()
	{
		if (TRUE == empty($this->_input['_POST']['name'])) $this->errors[] = $this->_lang['about'][11];
		elseif (30 < strlen(trim($this->_input['_POST']['name']))) $this->errors[] = $this->_lang['about'][12];
		...
		if (TRUE == empty($this->_input['_POST']['email'])) $this->errors[] = $this->_lang['about'][13];
		elseif (FALSE == $this->_isEmailAddress(trim($this->_input['_POST']['email']))) $this->errors[] = $this->_lang['about'][14];
		...
		elseif (FALSE == $this->_isEmailAddress(trim($this->_input['_POST']['msn']))) $this->errors[] = $this->_lang['about'][15];
