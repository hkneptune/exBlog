...
define('MODULE_NAME', 'core-adm.filemanager');
...
class FileManager extends CommonLib
{
	...
	function setXmlHeader()
	{
		...
		echo "<CurrentFolder path=\"" . $this->_convertToXmlAttribute($this->current_folder) . "\" url=\"{$this->folder_setting['up_url']}\" />";
	} 
	...
	function UploadFile($path = '')
	{
		...
		switch ($result)
		{
			case 2: $error_number = 202;
				break;
			case 6: $error_number = 201;
				break;
			default : $error_number = 0;
				break;
		} 
