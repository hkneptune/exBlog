 ...
 *
 * $Id: other.php,v 1.1.1.1 2005/07/01 09:21:21 feeling Exp $
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
class ModifySystemOptions extends CommonLib
{
	...
	function ModifySystemOptions()
	{
		...
		// 装入功能对应语言文件
		include_once("../{$this->_config['global']['langURL']}/other.php");
		$this->_lang['other'] = $lang;
		// 输入数据
...
//			$this->_printOutPage();
	...
	{
		if (TRUE == empty($this->_input['_POST'][$name])) $this->errors[$name] = $this->_lang['other'][35];
