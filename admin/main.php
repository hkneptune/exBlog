...
define('MODULE_NAME', 'core-adm.main');
...
class AdminHome extends CommonLib
{
	function AdminHome()
	{
		$this->_initEnv(MODULE_NAME, 'main', 4);

		if (FALSE == empty($this->_input['_GET']['action']) && 'delInstall' == $this->_input['_GET']['action']) $this->_delInstallFile();
	...
	function _listTeamMembers()
	{
		...
		$this->members['benefactor'] = array(
			...
			array('name' => 'neptune', 'email' => 'otherilike@msn.com'),
