 ...
 *		#4> $rssFeed->setItem("文章标题", "与文章相对应的网站URL", "与文章相对应的描述");
...
class RssFeedBuild
{
	...
	function RssFeedBuild()
	{
		...
		$this->rssHeader .= "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\" xmlns=\"http://purl.org/rss/1.0/\">\n";
	}
	 ...
	 */
	function setItem($title, $link, $description)
	{
		$this->rssItem .= "<item>\n";
