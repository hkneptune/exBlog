...
function selectAnnounce()
{
	...
	{
		$tmp.="<li>·<a href=\"#\" onclick=\"window.open('?play=announce&id=$rows[id]', 'newwindow', 'height=400, width=500, top=100,left=300, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')\">$rows[title]</a></li>";
		$tmp.="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	}
...
function searchInfo($key)
{
	...
	$sql=mysql_query("SELECT * FROM `$x[blog]` WHERE content LIKE '%$key%' union SELECT * FROM `$x[blog]` WHERE title LIKE '%$key%'");
...
{
	global $t, $x;
	$sql=mysql_query("SELECT * FROM `$x[comment]` ORDER BY id DESC LIMIT 0,21");
	$num=mysql_num_rows($sql);
	if($num == 0)
	{
		$t->set_var("comment","最近无评论内容");
...
function select5links()
{
	...
	if($num == 0)
	{
		$t->set_var(array("homepage"=>"目前无友情链接",
		                  "visits"=>"0"));
    ...
    for($iii=0; $iii<$i; $iii++)
    {
		if($logoURL[$iii] != "")
		{
			$homepage[$iii]="<img src=\"$logoURL[$iii]\" align=\"middle\" border=\"0\"  onerror=\"this.src='http://www.madcn.com/madcg/images/logo/logo1.gif'\">";
		}
...
if(checkunregist()&&$tmpBlog['hidden']=="1")
	{   $t->set_var(array("blogTitle"=>"该文章作者隐藏",
				"blogAuthor"=>"隐藏",
				"blogSort"=>"隐藏",
				"blogAddtime"=>"隐藏",
				"blogID"=>$curID,
				"blogWeather" => "./images/weather/null.gif"));
	}
else
	{
...
$tmpBlog['content']=preg_replace_callback("/\[html\]\s*(.+?)\[\/html\]/is",'runhtml', $tmpBlog['content']);
...
if($rows['html']=="0"){
	$rows['content']=htmlspecialchars($rows['content']);
$rows['content']=preg_replace_callback("/\[html\]\s*(.+?)\[\/html\]/is",'runhtml', $rows['content']);
	            $rows['content']=str_replace("\n","<br />",$rows['content']);
	            $rows['content']=str_replace("<br>","<br />",$rows[content]);
	            $rows['content']=str_replace("  ","&nbsp;",$rows[content]);
	            $rows['content']=str_replace("/\\t/is","  ",$rows[content]);
...
function selectCurSortArt($isort)
{
    ...
    if($num == 0)
    {
	    $t->set_var(array("blogTitle"=>"该分类目前无任何文章","currentSort"=>$sortName[cnName],"blogWeather" => "./images/weather/null.gif"));
...
if($rows['html']=="0"){
    ...
    $sql=mysql_query("SELECT * FROM `$x[blog]` ORDER BY id DESC LIMIT $start,$page_size");
	$num=mysql_num_rows($sql);

    if($num == 0)
    {
	    $t->set_block("b_blognull","RowBlog","RowsBlog");
           $t->set_var(array("blogTitle" => "目前无任何Blog.","blogWeather" => "./images/weather/null.gif"));
	    $t->parse("RowsBlog","RowBlog",true);
    }
    else
    {
...
{
   $message=preg_replace("/\:ex(.+?)\:/is","<img src=./images/ex_pose/ex\\1.gif>",$message);
	return $message;
}

/* 表情替换函数_暂留 */
function epost_old($message)
{
	global $tmpURL;
	$message=str_replace(":ex2_0:","<img src=./images/ex_pose/ex2_0.gif>",$message);
	$message=str_replace(":ex2_1:","<img src=./images/ex_pose/ex2_1.gif>",$message);
	$message=str_replace(":ex2_2:","<img src=./images/ex_pose/ex2_2.gif>",$message);
	$message=str_replace(":ex2_3:","<img src=./images/ex_pose/ex2_3.gif>",$message);
	$message=str_replace(":ex2_4:","<img src=./images/ex_pose/ex2_4.gif>",$message);
	$message=str_replace(":ex2_5:","<img src=./images/ex_pose/ex2_5.gif>",$message);
	$message=str_replace(":ex2_6:","<img src=./images/ex_pose/ex2_6.gif>",$message);
	$message=str_replace(":ex2_7:","<img src=./images/ex_pose/ex2_7.gif>",$message);
	$message=str_replace(":ex2_8:","<img src=./images/ex_pose/ex2_8.gif>",$message);
	$message=str_replace(":ex2_9:","<img src=./images/ex_pose/ex2_9.gif>",$message);
	$message=str_replace(":ex2_10:","<img src=./images/ex_pose/ex2_10.gif>",$message);

	$message=str_replace(":ex2_11:","<img src=./images/ex_pose/ex2_11.gif>",$message);
	$message=str_replace(":ex2_12:","<img src=./images/ex_pose/ex2_12.gif>",$message);
	$message=str_replace(":ex2_13:","<img src=./images/ex_pose/ex2_13.gif>",$message);
	$message=str_replace(":ex2_14:","<img src=./images/ex_pose/ex2_14.gif>",$message);
	$message=str_replace(":ex2_15:","<img src=./images/ex_pose/ex2_15.gif>",$message);
	$message=str_replace(":ex2_16:","<img src=./images/ex_pose/ex2_16.gif>",$message);
	$message=str_replace(":ex2_17:","<img src=./images/ex_pose/ex2_17.gif>",$message);
	$message=str_replace(":ex2_18:","<img src=./images/ex_pose/ex2_18.gif>",$message);
	$message=str_replace(":ex2_19:","<img src=./images/ex_pose/ex2_19.gif>",$message);
	$message=str_replace(":ex2_20:","<img src=./images/ex_pose/ex2_20.gif>",$message);

	$message=str_replace(":ex2_21:","<img src=./images/ex_pose/ex2_21.gif>",$message);
	$message=str_replace(":ex2_22:","<img src=./images/ex_pose/ex2_22.gif>",$message);
	$message=str_replace(":ex2_23:","<img src=./images/ex_pose/ex2_23.gif>",$message);
	$message=str_replace(":ex2_24:","<img src=./images/ex_pose/ex2_24.gif>",$message);
	$message=str_replace(":ex2_25:","<img src=./images/ex_pose/ex2_25.gif>",$message);
	$message=str_replace(":ex2_26:","<img src=./images/ex_pose/ex2_26.gif>",$message);
	$message=str_replace(":ex2_27:","<img src=./images/ex_pose/ex2_27.gif>",$message);
	$message=str_replace(":ex2_28:","<img src=./images/ex_pose/ex2_28.gif>",$message);
	$message=str_replace(":ex2_29:","<img src=./images/ex_pose/ex2_29.gif>",$message);
	$message=str_replace(":ex2_30:","<img src=./images/ex_pose/ex2_30.gif>",$message);

	$message=str_replace(":ex2_31:","<img src=./images/ex_pose/ex2_31.gif>",$message);
	$message=str_replace(":ex2_32:","<img src=./images/ex_pose/ex2_32.gif>",$message);
	$message=str_replace(":ex2_33:","<img src=./images/ex_pose/ex2_33.gif>",$message);
	$message=str_replace(":ex2_34:","<img src=./images/ex_pose/ex2_34.gif>",$message);
	$message=str_replace(":ex2_35:","<img src=./images/ex_pose/ex2_35.gif>",$message);
	$message=str_replace(":ex2_36:","<img src=./images/ex_pose/ex2_36.gif>",$message);
	$message=str_replace(":ex2_37:","<img src=./images/ex_pose/ex2_37.gif>",$message);
	$message=str_replace(":ex2_38:","<img src=./images/ex_pose/ex2_38.gif>",$message);
...
function addUser($name, $password, $email, $homepage, $qq)
{
	...
	$query = "SELECT name FROM `$x[user]` WHERE name = '$name' union SELECT user FROM `$x[admin]` WHERE user='$name'";
	$result = mysql_query($query);
...
function runhtml ($matches) {
	...
	$sss=str_replace("\n","◎〓",$sss);
return $sss."
	<div><TEXTAREA cols=\"70\" rows=\"20\" wrap=\"VIRTUAL\">$matches[1]</TEXTAREA>
	<INPUT onclick=runCode() type=button value=运行代码> [Ctrl+A 全部选择 提示：你可先修改部分代码，再按运行]</div>";
}
