...
function CreateBlog($i)
{
    ...
    $query.="nocom ENUM( '0', '1' ) DEFAULT '0' NOT NULL)";
    @mysql_query($query)
...
function CreateLinks($i)
{
	...
	$query="INSERT INTO `$i_links` (homepage, url, description, visits, visible)";
	$query.=" VALUES('exBlog\'s Home','http://www.exBlog.net','exSoft Team', '0', '1')";
    @mysql_query($query)
...
function CreateGlobal($i)
{
	...
	$query .= "Version VARCHAR( 20 ) DEFAULT 'exBlog 1.3.final' ,";
