<?php
/**
 * 1.2.0_beta_0909 [to] exBlog 1.3.final 升级程序
 *  2004-05-02
 */
...
function alterGlobal()
{
	...
	$query .= "ADD `Version` VARCHAR( 20 ) DEFAULT 'exBlog 1.3.final',"; //为了版本检测请按这个标准写这个: 'exBlog 1.3.0'
...
function CreateKeyword()
{
    ...
    @mysql_query($query)
    ? $result.="重置 `$x[keyword]` 成功!...... <font color='blue'>√</font><br />"
    : $result.="重置 `$x[keyword]` 失败! ...... <font color='red'>×</font><br />";
    ...
    @mysql_query($query)
    ? $result.="创建 `$x[keyword]` 成功!...... <font color='blue'>√</font><br />"
    : $result.="创建 `$x[keyword]` 失败! ...... <font color='red'>×</font><br />";
