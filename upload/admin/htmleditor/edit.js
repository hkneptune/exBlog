...
function document.onreadystatechange()
{
  ...
  Composition.document.write("<head><style type=\"text/css\">body {font-size: 10pt}</style><meta http-equiv=Content-Type content=\"text/html; charset=utf-8\"></head><BODY bgcolor=\"#FFFFFF\" MONOSPACE></body>");
...
var bLoad=false
var pureText=true
var bodyTag="<head><style type=\"text/css\">body {font-size:	10pt}</style><meta http-equiv=Content-Type content=\"text/html; charset=utf-8\"></head><BODY bgcolor=\"#FFFFFF\" MONOSPACE>"+self.opener.exEdit.content.value
var bTextMode=false

//var bodyTag="<head><style type=\"text/css\">body {font-size:	10pt}</style><meta http-equiv=Content-Type content=\"text/html; charset=utf-8\"></head><BODY bgcolor=\"#FFFFFF\" MONOSPACE>"
//var bodyTag=self.opener.exEdit.content.value
...
{
  if (!validateMode()) return;
   self.opener.exEdit.content.value=getPureHtml(Composition.document.body.innerHTML);
   self.close();
}
...
function help()
{
    ...
    helpmess="-----------------编辑器帮助---------------------\r\n\r\n"+
         "1.请不要发表有危险性的脚本。\r\n\r\n"+
         "2.如果要书写源代码，请选中\"查看HTML源代码\"书写.\r\n\r\n"+
         "3.需要你自己运行,才能看效果.\r\n\r\n"+
         "4.如果书写js，尽量不要在这儿书写.\r\n\r\n"+
         "             技术支持 --  http://www.madcn.com\r\n\r\n";
    alert(helpmess);
