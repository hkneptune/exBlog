<?php 
/*===========================================================================
*\    exBlog Ver: 1.3.1 exBlog 网络日志(PHP+MYSQL) 1.3.1 版
*\---------------------------------------------------------------------------
...
if($_GET['play'] == "" && $_GET['id'] == "" && $_POST['play'] == "" && $_POST['id'] == "")
{
...
elseif($_GET['play'] == "reply" || $_POST['play'] == "reply" || $_GET['id'] != "" && $_GET['play'] != "links" && $_GET['play'] != "show")
{
...
//	 }
	...
	showCurrentBlog($_GET['id'],$_GET['make'],$_GET['key']);
	showCurrentBlogComment($_GET['id'], $GLOBALS[nocom]);
	showCurrentTrackback($_GET['id'], $GLOBALS[nocom]);
