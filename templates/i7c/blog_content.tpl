            ...
            <TR> 
              <TD colspan="2" align=middle bgColor=#ffffff> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                  <TBODY>
                    <TR> 
                      <TD class=smalltxt 
                        align=middle ><div align="right"><a href="mailto:{$blog_info.email}" class="cn">{$blog_info.author}</a> 
                          in [{$blog_info.cnName}] | {$PHP_LANG.index[6]}{$blog_info.visits} 
...
<tr>
 ...
 <a href=""><img src="./templates/i7c/images/homepage.gif" title="" /></a></td>
</tr>
<tr>
	<td height="2" bgcolor="#FFFFFF"></td>
</tr>
