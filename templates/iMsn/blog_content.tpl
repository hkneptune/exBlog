          ...
          <td>
            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="content" style="WORD-BREAK: break-all; WORD-WRAP: break-word">
              ...
              <tr>
                ...
                <div style="color:#10659e;text-align:right;"><img src="./images/weather/{$blog_info.weather}.gif" /> Posted by <a href="mailto:{$blog_info.email}" class="cn">{$blog_info.author}</a> in [{$blog_info.cnName}] at {$blog_info.addtime|date_format:"%Y-%m-%d %H:%M:%S"} </div>
                {$blog_info.content}
                <br>
                </td>
              </tr>
...
<!--
<br />
<img src="./{$PHP_CONFIG.global.tmpURL}/images/tb.gif" alt="Trackback URI"/> <strong>{$PHP_LANG.index[4]}</strong> <a href="{$PHP_CONFIG.global.siteUrl}/extb.php?id=1">{$PHP_CONFIG.global.siteUrl}/extb.php?id={$blog_info.id}</a>
-->
                </td>
              </tr>
              <tr>
